<template>
  <div class="choose-question">
    <div class="l-header">
      ...
      <input type="text" class="question" placeholder="请输入题目标题" v-model.lazy="question" @change="handleChange">
    ...
    <div class="l-body">
      <div class="option-line" v-for="(item, index) in answers" :key="index">
        ...
        <input type="text" class="option-input" placeholder="选项内容" v-model.lazy="answers[index]" @change="handleChange">
      </div>
    </div>
    <div class="l-footer">
