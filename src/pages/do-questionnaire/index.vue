<template>
  <div class="do-questionnaire">
    ...
    <div class="footer">
      <button class="btn" @click="handleClickNext" v-if="nowQuestion !== list.length">下一题</button>
      <button class="btn" @click="handleSubmit" v-else :loading="btnLoading">提交</button>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      ...
      list: [
        ...
        {
          question: '什么什么什么什么什么什么什么什么什么什么什么什么什么什么什么什么',
          limit: 3,
          options: [
            'xxxxxxxxxxxx',
            'xxxxxxxx',
